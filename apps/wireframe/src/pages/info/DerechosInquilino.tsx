  ...
  return (
    <div className={styles.container}>
      ...
      <Typography as="p" className={styles.subtitle}>
        Conocer tus derechos como inquilino es fundamental para protegerte ante
        posibles abusos. A continuacion se resumen los principales derechos
        recogidos en la Ley de Arrendamientos Urbanos (LAU) vigente en Espana.
      </Typography>
      ...
      <WiredCard elevation={1} className={styles.footer}>
        <Typography as="p" className={styles.disclaimer}>
          Esta informacion es orientativa y no constituye asesoramiento legal.
          Consulta la LAU vigente para informacion legal precisa.
        </Typography>
