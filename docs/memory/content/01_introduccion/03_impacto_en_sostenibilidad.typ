...
+ *Infraestructura con credenciales ambientales verificables.* Se han priorizado proveedores como Scaleway (grupo iliad), que alimenta sus centros de datos con energía 100% renovable de origen eólico o hidroeléctrico, mantiene un PUE medio de 1,37 —frente al 1,55 de la media del sector— y obtuvo la medalla de oro de EcoVadis en 2024, situándose en el 5% de empresas más sostenibles evaluadas @scaleway_environment_2025.

+ *Arquitectura _serverless_ para el backend.* Según la revisión sistemática de #cite(<akour_serverless_2025>, form: "prose"), este paradigma reduce el consumo energético respecto a los despliegues tradicionales al mitigar la sobreaprovisión de recursos y escalar la computación estrictamente en función de la demanda.

+ *Ingesta periódica de datos frente a consultas en tiempo real.* La arquitectura de datos se ha diseñado con procesos de carga programada, lo que reduce la carga computacional sostenida en servidores.
...
El impacto más directo del proyecto en la dimensión ético-social reside en su contribución a reducir la asimetría informativa del mercado de la vivienda, documentada académicamente y reconocida por las instituciones como un problema estructural. Como se ha expuesto en la @sec:contexto, el informe del #cite(<idra_2024>, form: "prose") señaló que superar la opacidad del mercado del alquiler es una condición necesaria para garantizar los derechos de la ciudadanía inquilina, y la investigación de #cite(<civio_megatenedores_2024>, form: "prose") identificó que el 10% de los alquileres formalizados en España está controlado por apenas 737 megatenedores, una concentración que no es rastreable mediante fuentes públicas. La democratización del acceso a esta información es, por tanto, un acto de responsabilidad social con implicaciones concretas para el ejercicio de derechos.
...
Desde la perspectiva de género, los datos disponibles revelan una vulnerabilidad específica de los hogares encabezados por mujeres. El informe de #cite(<provivienda_genero_2023>, form: "prose") sobre el derecho a la vivienda de las mujeres documentó que el 33% de los hogares con mujer sustentadora principal cae en situación de pobreza relativa tras el pago de los gastos de vivienda —proporción que se eleva hasta el 59% entre quienes pagan alquiler a precio de mercado—, frente al 25% en los hogares encabezados por hombres. Según datos del INE (ECV 2024), el 80,7% de las familias monoparentales está encabezado por mujeres @provivienda_observatorio_monoparentales_2024, lo que convierte la intersección entre monoparentalidad y precariedad habitacional en una de las formas más severas de vulnerabilidad residencial en España. Esta interseccionalidad —género, estructura familiar, situación en el mercado laboral— es constitutiva del problema habitacional y debe estar presente en la forma en que se diseñan las visualizaciones y los indicadores de la plataforma. El ODS 5 (igualdad de género) y el ODS 10 (reducción de las desigualdades) establecen el marco normativo internacional pertinente.
