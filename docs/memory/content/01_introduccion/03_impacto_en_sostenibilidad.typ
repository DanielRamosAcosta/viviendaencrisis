...
#figure(
  table(
    ...
    [Huella de carbono operacional del alojamiento web.],
    [Despliegue en proveedores con compromisos de energía renovable. Optimización del rendimiento. Ingesta periódica de datos frente a consultas en tiempo real.],

    [Comportamiento ético y RS],
    [Reducción de la asimetría informativa. Empoderamiento de ciudadanía, organizaciones sociales y administraciones locales (ODS 16). Transparencia sobre concentración de propiedad.],
    ...
    [Diversidad y derechos humanos],
    [Visibilidad de las desigualdades habitacionales por género, edad y origen (ODS 5, ODS 10). Canal de documentación de discriminación. Accesibilidad para personas con diversidad funcional.],
